...
export default class TransactionScreen extends Component {
  ...
  handleTransaction = async () => {
    ...
    var transactioType = await this.checkBookAvailability(bookId);
    if(!transactioType){
      this.setState({bookId:"",studentId:""});
      // Apenas para usuários do IOS
      ...
      // Apenas para usuários do IOS
      //Alert.alert("O livro entregue ao aluno!");
      ToastAndroid.show("O livro entregue ao aluno!", ToastAndroid.SHORT);
    }else{
      ...
      // Apenas para usuários do IOS
      //Alert.alert("O livro entregue à biblioteca!");
      ToastAndroid.show("O livro entregue à biblioteca!", ToastAndroid.SHORT);
    }
  };
  ...
  checkBookAvailability = async bookId =>{
    ...
    if(bookRef.docs.length == 0){
      transactioType = false;
    }else{
        bookRef.docs.map(doc =>{
        transactioType = doc.data().is_book_available ? "issue" :"return";
      })
    }
    ...
    if(studentRef.docs.length == 0 ){
      ...
      studentRef.docs.map(doc =>{
        if(doc.data().number_of_books_issued < 2){
          ...
          isStudentEligible = false;
          // Apenas para usuários do IOS
      //Alert.alert("O aluno já tirou dois livros!");
      ToastAndroid.show("O aluno já tirou dois livros!", ToastAndroid.SHORT);
      this.setState({
        bookId:"",
        studentId:""
      })
